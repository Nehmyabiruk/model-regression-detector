...
class TimeSeriesModelEvaluator:
    """Evaluate time-series forecasting models preserving chronological order."""
    ...
    def evaluate(
        ...
        """Run the model and produce a structured forecasting evaluation result.

        The evaluation must preserve chronological ordering without random resampling.
        """
